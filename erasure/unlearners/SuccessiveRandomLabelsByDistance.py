...
class SuccessiveRandomLabelsByDistance(TorchUnlearner):
    def init(self):
        """
    ...
    def __unlearn__(self):
        ...
        self.info(f'Starting SRLByDistance with {self.epochs} epochs')
        ...
        for i, (feature, original_label) in enumerate(zip(all_features_np, all_labels_np)):
            ...
            for class_id in range(self.n_classes):
                if class_id != original_label:  # 排除原始标签
                    ...
                    distance = cosine_distance(feature, center)  # 使用余弦距离
        ...
        for epoch in range(self.epochs):
            ...
            self.info(f'SRLByDistance  - epoch = {epoch} ---> var_loss = {epoch_loss:.4f}')
